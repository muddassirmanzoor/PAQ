                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <form class="create-puc" method="POST" action="{{url('assembly-question')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-3">
                                            <div class="mb-3">
                                                <label for="dairyNo" class="form-label">Diary No  </label>
                                                <input type="text" id="dairyNo" name="dairy_no" class="form-control" placeholder="Enter Diary No">
                                            </div>
                                        </div>
                                        <div class="col-xl-3">
                                            <div class="mb-3">
                                                <label for="assamblyQuestionNo" class="form-label">Ass.Question No</label>
                                                <input type="text" id="assamblyQuestionNo" name="assembly_question_no" class="form-control" placeholder="Enter Question No">
                                            </div>
                                        </div>
                                        <div class="col-xl-6">
                                            <div class="mb-3">
                                                <label for="receivedBy" class="form-label">Received By</label>
                                                <input type="text" id="receivedBy"  name="receivedBy" class="form-control" placeholder="Name of User Logged">
                                            </div>
                                        </div>
                                        <div class="col-xl-6">
                                            <div class="mb-3">
                                                <label for="raisedBy" class="form-label">Assb. Question Raised by</label>
                                                <input type="text" id="raisedBy" name="raisedBy" class="form-control" placeholder="Enter Name">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="subject" name="subject" class="form-control" placeholder="Enter File Name Or Subject">
                                            </div>
                                        </div>
                                        <div class="col-xl-3">
                                            <div class="mb-3">
                                                <label for="assbSessionDate" class="form-label">Assb. Session Date</label>
                                                <input class="form-control" id="assbSessionDate" type="date" name="assbSessionDate" max="{{ now()->format('Y-m-d') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="letterIssuanceDate" type="date" name="letterIssuanceDate" max="{{ now()->format('Y-m-d') }}">
                                            </div>
                                        </div>
                                        <div class="col-xl-3">
                                            <div class="mb-3">
                                                <label for="recivingDate" class="form-label">Receiving Date</label>
                                                <input class="form-control" id="recivingDate" type="date" name="recivingDate" max="{{ now()->format('Y-m-d') }}">
                                            </div>
                                        </div>
                                        <div class="col-xl-3">
                                            <div class="mb-3">
...
{{--                                                    <option value="CEO Lahore">CEO Lahore</option>--}}
                                        ...
                                        <div class="col-xl-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea   class="form-control"  rows="7" name="description" placeholder="Enter Description" require></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="mb-3 text-right">
                                                <button type="submit" class="btn btn-primary"> Submit <i class="mdi mdi-arrow-right-bold"></i></button>
                                            </div>
                                        </div>
                                    </div><!-- end row-->
