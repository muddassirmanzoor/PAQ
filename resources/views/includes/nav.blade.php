...
{{--                    <!-- item-->--}}
{{--                    <a href="assembly-question-list.php" class="dropdown-item notify-item">--}}
...
{{--                <!-- All-->--}}
{{--                <a href="/assembly-question-list.php" class="dropdown-item text-center text-primary notify-item notify-all">--}}
{{--                    View All--}}
{{--                </a>--}}
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                        <span class="account-user-avatar">
                                            <div class="rounded-circle">A</div>
                                        </span>
                <span>
                                            <span class="account-user-name">{{auth()->user()->full_name}}</span>
                                            <span class="account-position">{{auth()->user()->designation}}</span>
                                        </span>
            </a>
